...
if __name__ == "__main__":
    ...
    def get_parameter():
        ...
        text_action_index.delete(1.0, tk.END)
        text_action_index.insert(1.0, obj_cam_operation.action)
    ...
    def set_parameter():
        ...
        obj_cam_operation.action = text_action_index.get(1.0, tk.END)
        obj_cam_operation.action = obj_cam_operation.action.rstrip("\n")
    ...
    label_action_index = tk.Label(window, text='action #', width=15, height=1)
    label_action_index.place(x=20, y=550)
    text_action_index = tk.Text(window, width=15, height=1)
    text_action_index.place(x=160, y=550)
